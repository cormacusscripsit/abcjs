...
| `deploy/6.7.0-tuplet` | upstream `main` (the 6.7.0 release) | What our own projects install. Upstream's release plus the one fix, nothing else. |
...
```json
"abcjs": "github:cormacusscripsit/abcjs#v6.7.0-tuplet.1"
```
...
git cherry-pick fix/1117-tuplet-duration  # re-apply the one commit
